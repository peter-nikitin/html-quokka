grammar Quokka;
options {
	tokenVocab = QuokkaLex;
}

// basic template structure

template: templateBlock? EOF;

templateBlock: (staticBlock | dynamicBlock)+;

staticBlock: (constantBlock | outputBlock)+;
...
ifCondition: ifInstruction templateBlock?;

elseCondition: elseInstruction templateBlock?;

elseIfCondition: elseIfInstruction templateBlock?;
...
forStatement: forInstruction templateBlock? endForInstruction;
